...
void printGyro()
{
  ...
  Serial.print(dof.calcGyro(dof.gx), 8);
  Serial.print(", ");
  Serial.print(dof.calcGyro(dof.gy), 8);
  Serial.print(", ");
  Serial.print(dof.calcGyro(dof.gz), 8);
...
void printAccel()
{
  ...
  Serial.print(dof.calcAccel(dof.ax), 8);
  Serial.print(", ");
  Serial.print(dof.calcAccel(dof.ay), 8);
  Serial.print(", ");
  Serial.print(dof.calcAccel(dof.az), 8);
#elif defined PRINT_RAW 
  Serial.print(dof.ax);
  Serial.print(", ");
  Serial.print(dof.ay);
...
void printMag()
{
  ...
  Serial.print(dof.calcMag(dof.mx), 8);
  Serial.print(", ");
  Serial.print(dof.calcMag(dof.my), 8);
  Serial.print(", ");
  Serial.print(dof.calcMag(dof.mz), 8);
#elif defined PRINT_RAW
  Serial.print(dof.mx);
  Serial.print(", ");
  Serial.print(dof.my);
