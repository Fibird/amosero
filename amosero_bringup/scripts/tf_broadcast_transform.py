...
def cmd_velCb(msg):
    ...
    global rospy,maximum_rad_per_seconds, cur_north, last_north
    ...
    #cur_th += delta_th
    #if(last_north != 0):
    #    cur_th += last_north - cur_north
    #else:
    #    cur_th += delta_th

    last_north = cur_north
    cur_th += delta_th
    ...
    rospy.loginfo("cur_north: [%f] last_north: [%f]"%(cur_north,last_north))
    rospy.loginfo("th: [%f, %f] north: [%f]"%(delta_th,cur_th,north))
    rospy.loginfo("cur: [%f, %f, %f]"%(cur_linear_x, cur_linear_y, cur_th))
    ...
    odom.pose.pose.position.x = cur_linear_x 
    odom.pose.pose.position.y = cur_linear_y 
